...
async def draw_music_info(music: Music) -> MessageSegment:
    ...
    sy.draw(350, 980, 14, f'Designed by Yuri-YuzuChaN | Generated by {BOTNAME} BOT', (255, 255, 255, 255), 'mm', 1,
            (159, 81, 220, 255))
...
async def music_play_data(qqid: int, songs: str) -> Union[str, MessageSegment, None]:
    ...
    try:
        ...
        sy.draw(450, 1180, 20, f'Designed by Yuri-YuzuChaN | Generated by {BOTNAME} BOT', (159, 81, 220, 255), 'mm', 2,
                (255, 255, 255, 255))
        msg = MessageSegment.image(image_to_base64(im))
